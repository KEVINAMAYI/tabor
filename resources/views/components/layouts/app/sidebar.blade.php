                                                ...
                                                <a href="default-sidebar/app-email.html"
                                                   class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-inline-block">
                                                        ...
                                                        <span
                                                            class="fs-11 d-block text-body-color">Get new emails</span>
                                                    </div>
                                                </a>
                                            </li>
                                            <li class="sidebar-item py-2">
                                                ...
                                                <a href="default-sidebar/app-contact.html"
                                                   class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-inline-block">
                                                        ...
                                                        <span
                                                            class="fs-11 d-block text-body-color">Add new contact</span>
                                                    </div>
                                                </a>
                                            </li>
                                            <li class="sidebar-item py-2">
                                    ...
                                    <li class="nav-item dropdown nav-icon-hover-bg rounded-circle">
                                        ...
                                        <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                                            ...
                                            <div class="d-flex align-items-center justify-content-between py-3 px-7">
                                                ...
                                                <span
                                                    class="badge text-bg-primary rounded-4 px-3 py-1 lh-sm">5 new</span>
                                            </div>
