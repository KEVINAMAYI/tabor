...
<head>
    ...
    <style>
        ...
        footer .d-flex.gap-9 a:hover img {
            filter: brightness(0) invert(0.65) sepia(1) saturate(5) hue-rotate(15deg) !important;
            /* orange glow */
        }
...
{{--                        </li>--}}
                        ...
                        <li class="nav-item">
                            <a href="{{ route('front-end.faqs') }}"
                                class="{{ request()->routeIs('front-end.faqs')
                                    ? 'btn btn-dark btn-sm py-2 px-4 mx-1'
                                    : 'nav-link fs-4 fw-bold text-dark link-primary px-3' }}">
                                FAQs
                            </a>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
            <ul class="list-unstyled ps-0">
                ...
                <li class="mb-1">
                    <a href="{{ route('front-end.faqs') }}"
                        class="px-0 fs-4 d-flex align-items-center justify-content-start gap-2 w-100 py-2 text-dark link-primary {{ request()->routeIs('front-end.faqs') ? 'active' : '' }}">
                        FAQs
...
{{--                </li>--}}
    ...
    <footer class="bg-dark">
        <div class="container-fluid">
            ...
            <div
                class="d-flex justify-content-between flex-wrap align-items-center py-5 border-top border-dark-subtle">
