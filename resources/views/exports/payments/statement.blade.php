...
<body style="background:#f2f4f7; padding: 18px;">
    ...
    @php
        ...
        // ---------- Ledger: compute balances on ASC ----------
        ...
        // Display ASC (your screenshot is oldest->newest)
        $rowsToDisplay = $withBalance->values();

        $finalBalance = $withBalance->last()['balance'] ?? $opening;

        // Do we show B/F and C/F lines?
        $hasRows = $rowsToDisplay->count() > 0;
        $showBF = $opening != 0; // only if non-zero
        $showCF = $hasRows || $showBF; // show C/F if anything exists
    @endphp
    ...
    <div id="statement" class="receipt-print">
        <div
            ...
            <table style="width: 100%; font-size: 13px; border-collapse: collapse; margin-bottom: 15px;">
                ...
                <tr>
                    <td style="color: #555;">Trimester:</td>
            ...
            <div style="border: 1px solid #ddd; border-radius: 6px; margin-bottom: 20px;">
                ...
                <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
                    ...
                    <tr>
                        <td style="padding: 8px 15px; border-bottom: 1px solid #eee;"><strong>Course:</strong></td>
                ...
                <div style="padding: 12px 15px;">
                    <div style="overflow-x: auto;">
                        <table style="width: 100%; border-collapse: collapse; font-size: 13px; min-width: 560px;">
                            <thead>
                                <tr>
                                    <th style="text-align: left; padding: 10px 8px; border-bottom: 1px solid #ddd; color: #0e334e;">Date</th>
                                    <th style="text-align: left; padding: 10px 8px; border-bottom: 1px solid #ddd; color: #0e334e;">Description</th>
                                    <th style="text-align: right; padding: 10px 8px; border-bottom: 1px solid #ddd; color: #0e334e;">Charges</th>
                                    <th style="text-align: right; padding: 10px 8px; border-bottom: 1px solid #ddd; color: #0e334e;">Payments</th>
                                    <th style="text-align: right; padding: 10px 8px; border-bottom: 1px solid #ddd; color: #0e334e;">Balance</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" style="padding: 12px 8px; border-bottom: 1px solid #eee; color:#777; text-align:center;">
                                ...
                                @if ($showCF)
                                    <tr>
                                        <td style="padding: 9px 8px; border-top: 1px dashed #ccc;"></td>
                                        <td style="padding: 9px 8px; border-top: 1px dashed #ccc; font-weight: 700; color:#0e334e;">
                                            Balance C/F
                                        </td>
                                        <td style="padding: 9px 8px; border-top: 1px dashed #ccc;"></td>
                                        <td style="padding: 9px 8px; border-top: 1px dashed #ccc;"></td>
                                        <td style="padding: 9px 8px; border-top: 1px dashed #ccc; text-align: right; font-weight: 800; color:#0e334e;">
                    ...
                    <div style="margin-top: 14px; border-top: 1px dashed #ccc; padding-top: 12px;">
                        <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                            <tr>
                                ...
                                <td style="text-align: right; font-weight: 600;">KES {{ $fmtMoney($totalCharges) }}</td>
                            </tr>
                            <tr>
                                <td style="color: #555;">Total Payments:</td>
                                <td style="text-align: right; font-weight: 600;">KES {{ $fmtMoney($totalPayments) }}</td>
                            </tr>
                            <tr>
            ...
            <div style="text-align: center; font-size: 13px; color: #555;">
                ...
                <p style="font-size: 12px; color: #888; margin-top: 8px;">
                    ...
                    <a href="mailto:office@tabor.ac.ke" style="color: #0e334e; text-decoration: none;">office@tabor.ac.ke</a>
                </p>
