        ...
        <tbody>
            ...
            @forelse ($enrollments as $enrollment)
                <tr class="search-items">
                    ...
                    <td>{{ number_format($enrollment->course?->price - $enrollment->payments?->sum('amount'), 2) }}
                    </td>
                    ...
                    <td>
                        <div class="action-btn dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="studentActions">
                                ...
                                @can('edit-students')
                                    <li>
                                        <a href="javascript:void(0)" {{-- wire:click="editStatus({{ $enrollment->id }})" --}} class="dropdown-item">
